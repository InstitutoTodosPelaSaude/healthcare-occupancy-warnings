...
**Rows:** 17 (one per monitored unit). Source of Table S1.
...
| `distrito`, `bairro`, `search_term` | string | Internal lookup fields, dropped when Table S1 is built | — |
...
`results/supp_tables/Supplementary Data *.xlsx` has a **Data dictionary** sheet,
generated by `scripts/09_export_supp_tables.py`.
